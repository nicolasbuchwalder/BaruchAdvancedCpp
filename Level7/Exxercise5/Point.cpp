...
NewDistanceStrategy* Point::_strategy;

// setting strategy
void Point::setStrategy(NewDistanceStrategy* strategy) { _strategy = strategy; };
...
double Point::Distance(const Point& p, NewDistanceStrategy* strategy) {
